...
<div class="row">
    <div class="container">
    <h2>News</h2>
    <p><a href="how-to/gcp-install-debian-ubuntu/">Install gcloud and docker-machine on debian/ubuntu</a></p>
    <p>Discussion: <a href="how-to/user-stories/">Product development using User Stories</a></p>
    </div>
</div>
